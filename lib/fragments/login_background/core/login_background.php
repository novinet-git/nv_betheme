...
?>
<?php $sBackground = $oAddon->getConfig('login_background_image') ? "/media/" . $oAddon->getConfig('login_background_image') : rex_url::addonAssets('nv_betheme', 'images/novinet-background-abstract.jpg'); ?>
